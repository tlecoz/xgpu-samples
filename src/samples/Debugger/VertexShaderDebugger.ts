...
export class VertexShaderDebugger extends ComputePipeline {
    ...
    public onLog: (results: any[], nbValueByFieldName: any) => void;

    private onUpdate: () => void;

    constructor(renderPipeline: RenderPipeline, config: { nbVertex: number, startVertexId: number, instanceId: number }) {
        super();
        ...
        */
        ...
        vertexBufferIO.onOutputData = (data) => {
            ...
            vertexBufferIO.getVertexInstances(result, (o) => {
                ...
                if (this.onLog && outputResultId == config.nbVertex) this.onLog(outputResults, nbValueByFieldName);
