...
export class ModelViewMatrix extends Matrix4x4 {
    ...
    constructor(model?: Matrix4x4, view?: Matrix4x4) {
        super();
        this.className = "mat4x4<f32>"

        this.model = model ? model : new Matrix4x4();
        this.view = view ? view : new Matrix4x4();
    }

    public clone(): ModelViewMatrix {
        return new ModelViewMatrix(this.model.clone() as Matrix4x4, this.view.clone() as Matrix4x4)
    }
    ...
    public update() {
        //console.log("modelViewMatrix.update")
