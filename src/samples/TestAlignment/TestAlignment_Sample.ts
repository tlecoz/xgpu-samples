import { BuiltIns, Float, GPURenderer, IVec4, IVec4Array, Matrix2x2, Matrix2x3, Matrix3x3, Matrix4x4, RenderPipeline, TextureSampler, UniformGroup, UniformGroupArray, Vec2, Vec3, Vec4, Vec4Array } from "xgpu";
...
export class TestAlignment_Sample extends Sample {
    ...
    private test01(renderer: GPURenderer) {
